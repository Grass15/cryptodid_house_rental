    ...
    const onFinish = (values) => {
      ...
      const Communicate = () => {
        ...
        ws.onopen = () => {
          ...
          console.log("ws://cryptodid.herokuapp.com/verify");
    ...
    const ApplicationForm = () => (
        ...
        >
            ...
            <div id='req-claims-container'>
                {targetHouse.RequiredClaims && targetHouse.RequiredClaims.map((e,i) =>(
                       <p>{e}  &nbsp;&nbsp;&nbsp;{verifiedClaim[i] == false? <InfoCircleOutlined size={"large"} style={{fontSize:'20px'}}/> : <CheckCircleFilled size='large' style={{color : '#52c41a',fontSize:'20px'}} /> }</p>
